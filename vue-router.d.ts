 ...
 */
export declare function createRouterMatcher(
 ...
 */
declare type HistoryStateValue =
  | string
  | number
  | boolean
  | null
 ...
 * @public
 */
export declare type LocationQuery = Record<
  string,
 ...
 * @public
 */
export declare type LocationQueryRaw = Record<
  string | number,
 ...
 * @internal
 */
export declare type LocationQueryValueRaw =
  | LocationQueryValue
  | number
  | undefined
 ...
 * @internal
 */
export declare const matchedRouteKey: InjectionKey<
...
declare type MatcherLocationRaw =
  | LocationAsPath
  | LocationAsName
  | LocationAsRelative
...
declare interface NavigationRedirectError
...
export declare type PathParserOptions = Pick<
  _PathParserOptions,
 ...
 */
export declare interface RouteLocationNormalizedLoaded
 ...
 */
export declare type RouteLocationRaw =
  | string
...
export declare type RouteParams = Record<
  string,
  RouteParamValue | RouteParamValue[]
>

export declare type RouteParamsRaw = Record<
  string,
 ...
 * @internal
 */
export declare type RouteParamValueRaw =
  | RouteParamValue
  | number
  | null
  | undefined
 ...
 * @internal
 */
export declare type RouteRecordRedirectOption =
  | RouteLocationRaw
 ...
 * @internal
 */
export declare const routerViewLocationKey: InjectionKey<
